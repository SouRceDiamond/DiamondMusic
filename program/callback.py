        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹قناة البوت›", url=f"https://t.me/CR_T2"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "‹𝘿ٌِ𝙀ٓ𝙑 ٰ𝙎𝘼𝙇𝘼𝙃›", url="https://t.me/BK_ZT"
                    )
                ],
            ]
        ),
...
2.) **بعد كدا, قم بترقيتي كمسئول.**
3.) **بعد كدا اكتب, .تحديث لتحديث البيانات.**
...
᥀ كلمات - اظهار كلمات اغنية
᥀ روابط - اظهار رابط اغنية

᥀ ينج - عرض حالة البوت بينغ
᥀ فحص - اظهار حاله البوت ان يعمل او لا
